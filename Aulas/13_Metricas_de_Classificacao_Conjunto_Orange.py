#===============================================================================
#
#  EXPERIMENTO 10.1 - CLASSIFICADORES KNN E REGRESSAO LOGISTICA
#                    PARA O CONJUNTO ORANGE COM METRICAS DE ERRO
#
...
#-------------------------------------------------------------------------------
# Verificar métricas de erro de classificação - REGRESSÃO LOGÍSTICA
#-------------------------------------------------------------------------------
...
tp = sum (  y_resposta &  y_teste )
fp = sum (  y_resposta & ~y_teste )
tn = sum ( ~y_resposta & ~y_teste )
fn = sum ( ~y_resposta &  y_teste )

print ( " " )
print ( "Matriz de Confusão (calculada):")
print ( np.array([[tp,fn],[fp,tn]]) )
print ( " " )
print ( "Matriz de Confusão (classe confusion_matrix):")
print ( confusion_matrix(y_teste,y_resposta,labels=[True,False]) )

print ( " " )
print ( "Acurácia (calculada)         : %6.1f %%" % (100*(tp+tn)/(tp+tn+fp+fn)) )
print ( "Acurácia (accuracy_score)    : %6.1f %%" % (100*accuracy_score(y_teste,y_resposta)) )

print ( " " )
print ( "Precisão (calculada)         : %6.1f %%" % (100*tp/(tp+fp)) )
print ( "Precisão (precision_score)   : %6.1f %%" % (100*precision_score(y_teste,y_resposta)) )

print ( " " )
print ( "Sensibilidade (calculada)    : %6.1f %%" % (100*tp/(tp+fn)) )
print ( "Sensibilidade (recall_score) : %6.1f %%" % (100*recall_score(y_teste,y_resposta)) )

print ( " " )
print ( "Score F1 (f1_score)          : %6.1f %%" % (100*f1_score(y_teste,y_resposta)) )

print ( " " )
print ( "Área sob ROC (roc_auc_score) : %6.1f %%" % (100*roc_auc_score(y_teste,y_resposta)) )

plot_roc_curve(classificador,x_teste,y_teste)
plot_precision_recall_curve(classificador,x_teste,y_teste)
